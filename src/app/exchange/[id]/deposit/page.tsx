...
export default function DepositPage() {
  ...
  return (
    <CheckoutShell
      ...
      subtitle="On a real exchange this is where you'd fund the order."
    >
      {(request) => {
        ...
        return (
          <>
            <p className="flex items-start gap-2 rounded-xl border border-red-500/25 bg-red-500/10 p-3 text-xs text-red-600 dark:text-red-400">
              ...
              This address is invalid on purpose and the code below is not scannable. Do not
              attempt to send real funds — no wallet will accept this destination.
            </p>
